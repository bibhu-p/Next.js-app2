        ...
        <>
            <div className="flex flex-col items-center ">
                <div className=" mt-6 w-full flex justify-end ">
                    <button onClick={()=> addMovie()} className="mr-16 bg-gray-600 w-[4rem] h-10 text-white rounded-md hover:bg-gray-800 flex justify-center items-center font-semibold transition ease-in-out hover:duration-300"><RiAddBoxLine size={25} /></button>
                </div>
